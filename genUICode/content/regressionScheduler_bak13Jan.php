...
<vbox flex="1" equalsize="always" style="overflow-x:auto; overflow-y:auto">
    ...
    <tabs>
        ...
        <tab id="reg_sched_job" label="Create Test Suite" flex="1" onclick="if(document.getElementById('test_dut_menulist').selectedIndex == 0){UserInterface.loadMenuItems('test_dut_menulist',{'obj':'Regressionjob','method':'loadListItems','listName':'DUT','listType':'dropdown','selectStr':'Select DUT'});}"/>
