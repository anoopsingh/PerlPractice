...
<broadcasterset>
  ...
  ?>
  <broadcaster id="objTree_regjobqueue_count" value="0"/>
  <broadcaster id="objTree_regjobqueue_results_count" value="0"/>
  <broadcaster id="objTree_regtestbedtopology_count" value="0"/>
...
<popupset>
    ...
    <menupopup id="objTree_regsuite_popup">
        <!--
        <menuitem class="menuitem-iconic" image="/imgs/icons/set1/edit.gif" label="Edit Suite" oncommand="document.getElementById('userInputTabs').selectedTab=document.getElementById('load_test');editTestcase();" />
...
<vbox flex="1" equalsize="always" style="overflow-x:auto; overflow-y:auto">
    ...
    <tabs>
        <tab id="reg_sched_job" label="Run Regression Test" flex="1"  onclick="if(document.getElementById('reg_dut_menulist').selectedIndex == 0){UserInterface.loadMenuItems('reg_dut_menulist',{'obj':'Regressionjob','method':'loadListItems','listName':'DUT','listType':'dropdown','selectStr':'Select DUT'});}"/>
        <tab id="load_test"  label="Create Test Suite" flex="1" onclick="if(document.getElementById('reg_dut_menulist').selectedIndex == 0){UserInterface.loadMenuItems('reg_dut_menulist',{'obj':'Regressionjob','method':'loadListItems','listName':'DUT','listType':'dropdown','selectStr':'Select DUT'});}"/>
        <tab id="load_testlist" label="Saved Test Suites" flex="1"/>
    </tabs>
    <tabpanels flex="1">
        <tabpanel flex="1">
          <vbox flex="1" >
              <grid>
                <rows flex="1">
                  ...
                  <row>
                    ...
                    <button  class="createBtn" label=" Suites/Tests  " image="/imgs/icons/set1/add.gif" />
                  </row>
                  <row>
                    <label></label>
                    <groupbox>
                      ...
                      <vbox>
                        <row>
                            ...
                            <checkbox id="scmMode" label="SCM Mode" checked="False"/>
                        </row>
                      </vbox>
                    </groupbox>
                  </row>
              ...
              <grid>
                <rows flex="1">
                  ...
                  <row>
                    ...
                    <textbox id="reg_suitetests" value="" placeholder="1934,1234"/>
