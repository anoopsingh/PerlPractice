              ...
              <grid>
                <rows flex="1">
                  ...
                  <row>
                    ...
                    <button  class="createBtn" label=" Suites/Tests  " image="/imgs/icons/set1/add.gif" onclick="document.getElementById('popuptype').value='suites';UserInterface.openDialogBox('/overlay/regressionScheduler_dialog.xul','popupWindow',400,500)"/>
                  </row>
                  <row>
                    <label></label>
                    <groupbox>
